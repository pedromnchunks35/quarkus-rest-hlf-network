...
public class EndorsementMapperImpl implements EndorsementMapper {
    ...
    @Override
    public Endorsement toEntity(EndorsementDTO EndorsementDTO) {
    ...
    @Override
    public EndorsementDTO toDto(Endorsement Endorsement) {
        if ( Endorsement == null ) {
            return null;
        }
    ...
    @Override
    public List<Endorsement> toEntity(List<EndorsementDTO> EndorsementDTOList) {
        if ( EndorsementDTOList == null ) {
            return null;
        }

        List<Endorsement> list = new ArrayList<Endorsement>( EndorsementDTOList.size() );
        for ( EndorsementDTO endorsementDTO : EndorsementDTOList ) {
            list.add( toEntity( endorsementDTO ) );
        }
    ...
    @Override
    public List<EndorsementDTO> toDto(List<Endorsement> EndorsementList) {
        if ( EndorsementList == null ) {
            return null;
        }

        List<EndorsementDTO> list = new ArrayList<EndorsementDTO>( EndorsementList.size() );
        for ( Endorsement endorsement : EndorsementList ) {
            list.add( toDto( endorsement ) );
        }
