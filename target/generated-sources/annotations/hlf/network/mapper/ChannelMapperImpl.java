...
public class ChannelMapperImpl implements ChannelMapper {
    ...
    @Override
    public List<Channel> toEntity(List<ChannelDTO> ChannelDTOList) {
    ...
    @Override
    public List<ChannelDTO> toDto(List<Channel> ChannelList) {
        if ( ChannelList == null ) {
            return null;
        }
    ...
    protected Block blockDTOToBlock(BlockDTO blockDTO) {
        ...
        block.setChannel( toEntity( blockDTO.getChannel() ) );
    ...
    protected BlockDTO blockToBlockDTO(Block block) {
        ...
        blockDTO.setChannel( toDto( block.getChannel() ) );
