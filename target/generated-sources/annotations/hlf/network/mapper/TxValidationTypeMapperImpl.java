...
@Generated(
    ...
    date = "2024-07-26T14:20:16+0200",
    comments = "version: 1.3.1.Final, compiler: javac, environment: Java 21.0.3 (Oracle Corporation)"
)
public class TxValidationTypeMapperImpl implements TxValidationTypeMapper {

    @Override
    public TxValidationType toEntity(TxValidationTypeDTO TxValidationTypeDTO) {
    ...
    @Override
    public TxValidationTypeDTO toDto(TxValidationType TxValidationType) {
    ...
    @Override
    public List<TxValidationType> toEntity(List<TxValidationTypeDTO> TxValidationTypeDTOList) {
        if ( TxValidationTypeDTOList == null ) {
            return null;
        }

        List<TxValidationType> list = new ArrayList<TxValidationType>( TxValidationTypeDTOList.size() );
        for ( TxValidationTypeDTO txValidationTypeDTO : TxValidationTypeDTOList ) {
            list.add( toEntity( txValidationTypeDTO ) );
        }
    ...
    @Override
    public List<TxValidationTypeDTO> toDto(List<TxValidationType> TxValidationTypeList) {
        if ( TxValidationTypeList == null ) {
            return null;
        }

        List<TxValidationTypeDTO> list = new ArrayList<TxValidationTypeDTO>( TxValidationTypeList.size() );
        for ( TxValidationType txValidationType : TxValidationTypeList ) {
            list.add( toDto( txValidationType ) );
        }
    ...
    protected Transaction transactionDTOToTransaction(TransactionDTO transactionDTO) {
        ...
        transaction.setTxValidationType( toEntity( transactionDTO.getTxValidationType() ) );
    ...
    protected TransactionDTO transactionToTransactionDTO(Transaction transaction) {
        ...
        transactionDTO.setTxValidationType( toDto( transaction.getTxValidationType() ) );
